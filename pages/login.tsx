  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen loginBackground">
      ...
      <main className="relative flex w-full h-screen z-10 justify-center">
        <div className="flex flex-col pb-8 pt-8  h-[320px] bg-blackish20 px-12 rounded-md min-w-[240px]">
          <h1 className="text-white10 font-bold text-3xl mb-8">Log In</h1>
          <input
            type="email"
            placeholder="Email address"
            className="p-2 text-blackish30 w-full pb-4 h-12 min-w-[240px] text-lg"
            onChange={handleOnChangeEmail}
          />
          <p className="my-1 text-white20">{userMsg}</p>
          <button
            onClick={handleLoginWithEmail}
            className="bg-redish10 px-12 py-2 text-lg text-white10 w-full rounded-md mt-12"
          >
            Login
          </button>
        </div>
